...
setup() {
    ...
    cp ./get_date_month.bash "$TEST_DIRECTORY/get_date_month.bash"
...
@test "get_date_month.bash - print month" {
    run bash -c '
        cd "$TEST_DIRECTORY"
        source ./get_date_month.bash
        get_date_month ./receipts/receipt
    '
...
@test "get_date_month.bash - exit if file of receipt not exist" {
    run bash -c '
        cd "$TEST_DIRECTORY"
        rm -rf ./receipts/
        source ./get_date_month.bash
